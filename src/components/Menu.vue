<template>
  <Slide class="mobile-slide">
    ...
    <v-list nav dense class="header-list-main">
      <v-list-item link :class="{ 'moblie-menu-active': isActiveRoute('/portfolio') }">
        <v-list-item-icon class="header-main-m">
          ...
          <span @click="changeRoute('portfolio')">
            Portfolio
          </span>
        </v-list-item-icon>
      </v-list-item>
      <v-list-item link :class="{ 'moblie-menu-active': isActiveRoute('/property') }">
        <v-list-item-icon class="header-main-m">
